...
const columns = [
  { id: 'name', label: 'Surname', minWidth: 170 },
...
const Department = () => {
  ...
  <>
    ...
    > <Typography
        sx={{ m: 1 }}
        variant="h4"
        style={{marginLeft:'50px', marginTop:'-40px', marginBottom:'30px'}}>
      
        Department
      </Typography>

      
      <text style={{marginLeft:'50px',fontSize:"20px", fontWeight:"bold"}}>Enter Department Code</text>
          <br></br>
      ...
      noValidate
      autoComplete="off"
      style={{marginTop:'10px', marginLeft:'43px', display:'flex',flexDirection:'row'}}
    >
          ...
          <Button 
          variant="contained"
          style={{width:"125px", height:"55px", backgroundColor: '#438029',}}
          ...
          ><text style={{color:'black'}}>Alphabetical Order</text></Button>
...
<Paper sx={{ width: '70%', overflow: 'hidden'}}
    ...
    >
    <Box sx={{width:'100%', height:'45%', backgroundColor:'white', borderColor:'gainsboro', borderWidth:1, paddingTop:2, paddingLeft:2}}>
      <text style={{fontSize:24, fontWeight:'bold'}}>Faculty Profile</text>
      <Avatar
      alt="Remy Sharp"
      src="/static/images/avatar/1.jpg"
      sx={{position:'relative', top:'30%', left:'24%', width:200, height:200, border:10, borderColor:'white' }}
    />
    </Box>
    <Box sx={{textAlign: 'center', m: 1, paddingTop:15}}>
      <text style={{fontWeight:'bold', color:'white', letterSpacing:2, fontSize:18}}>{data}</text>
      <br></br>
      <text style={{color:'white', letterSpacing:2, fontSize:18}}>adrianmagpayo@gmail.com</text>
    </Box>
    </Box>
